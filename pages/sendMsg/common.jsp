...
<%@page errorPage="/pages/sendMsg/exception.jsp" %>
<jsp:useBean id="messageService" scope="application" class="com.popbill.api.message.MessageServiceImp"/>

<%-- 링크아이디 --%>
<jsp:setProperty name="messageService" property="linkID" value="JEONBUK"/>

<%-- 비밀키, 사용자 인증에 사용되는 정보이므로 유출에 주의 --%>
<jsp:setProperty name="messageService" property="secretKey" value="HqEgSpagvtfSFps3TKiMLteIy1MQBtJSNsAShz0NL+I="/>
